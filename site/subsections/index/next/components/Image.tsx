...
export default class Imager extends Component<t.noteAtFullscreenProps, t.noteAtFullscreenStats> {
	...
	_changeImage(clientX, clientY, reduce, multiply) {
	...
	private _getImageScale(reduce, multiply?): void {
	...
	private _getImageJsx(url): JSX.Element | void {
	...
	render(): JSX.Element {
		let jsx = []
		jsx.push(this._getImageJsx(this.state.bigImageSrc))
		jsx.push(this._getImageJsx(this.state.mediumImageSrc))
		return jsx
	}
