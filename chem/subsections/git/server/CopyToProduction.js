class CopyToProduction {
	...
	getDump() {
		return new Promise(async success => {
			...
			this.o.Server.setError('CopyToProduction', 'getDump', err)
		})
	}
	...
	copyFiles(gitCmd) {
		return new Promise(async success => {
			...
			this.o.Server.setError('CopyToProduction', 'copyFiles', err)
		})
	}
	...
	merge(gitCmd) {
		return new Promise(async success => {
			...
			this.o.Server.setError('CopyToProduction', 'merge', err)
		})
	}
	...
	_copyFile(from, to) {
		return new Promise(async success => {
			...
			this.o.Server.setError('CopyToProduction', '_copyFile', err)
		})
	}
	...
	_deleteOldDumps() {
		return new Promise(async success => {
			...
			this.o.Server.setError('CopyToProduction', '_deleteOldDumps', err)
		})
	}
